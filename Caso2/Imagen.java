...
* */ 
    ...
    */ 
     ...
     * Método para recuperar la longitud del mensaje escondido en una imagen.
     *
     * @pre La matriz `imagen` debe haber sido inicializada con una imagen que contiene un mensaje escondido.
    ...
    public int leerLongitud2(FileWriter fw, int tamanoPagina) throws IOException {
        ...
        // La información de estos 16 bits está dispersa en los primeros 16 bytes de la imagen.
        ...
        for (int i = 0; i < 16; i++) {
            ...
            // `(i % (ancho * 3)) % 3` selecciona el canal (R, G, B) en el que se encuentra el bit.
            ...
            fw.write("Imagen[0][" + col + "]." + (canal == 0 ? "R" : (canal == 1 ? "G" : "B")) + "," + paginaVirtual + "," + desplazamiento + ",R\n");
        }

        // Retorna el valor de longitud, que ahora contiene los primeros 16 bits decodificados.
        return longitud;
    }
    ...
    */ 
    ...
    public void recuperar2(char[] cadena, int longitud, FileWriter fw, int tamanoPagina, int numeroFilas, int numeroColumnas) throws IOException {
    // El número de bytes en cada fila de la imagen, considerando tres canales (RGB).
    int bytesFila = ancho * 3;
    ...
    for (int posCaracter = 0; posCaracter < longitud; posCaracter++) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            // Se inicia en el byte 16 para omitir los primeros 2 caracteres, que almacenan la longitud del mensaje.
            int numBytes = 16 + (posCaracter * 8) + i;

            // Calcula la fila de la imagen en función del número total de bytes.
            int fila = numBytes / bytesFila;

            // Calcula la columna de la imagen, teniendo en cuenta los tres canales de color por píxel.
            int col = (numBytes % bytesFila) / 3;
            ...
            // Luego, se desplaza el bit a la posición adecuada con `<< i` y se combina con el carácter en construcción.
            ...
            fw.write("Imagen[" + fila + "][" + col + "]." + (canal == 0 ? "R" : (canal == 1 ? "G" : "B")) + "," + paginaVirtual + "," + desplazamiento + ",R\n");
    ...
    public void opcion1() {
        ...
        try {
            ...
            System.out.println("Tamano de pagina en bytes: ");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (FileWriter fw = new FileWriter("referencias.txt")) {
                ...
                // Añadir las referencias generadas para el mensaje durante la recuperación
                char[] mensaje = new char[longitud];
                imagen.recuperar2(mensaje, longitud, fw, tamanoPagina, numeroFilas, numeroColumnas);
            }
            System.out.println("Archivo de referencias generado correctamente.");
        } catch (Exception e) {
            e.printStackTrace();
